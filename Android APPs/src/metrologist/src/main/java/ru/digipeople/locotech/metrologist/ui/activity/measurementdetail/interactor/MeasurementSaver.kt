...
/**
 * Класс выполняющий сохранение на экране детальной информации замера
 */
class MeasurementSaver @Inject constructor(private val thingsWorxWorker: ThingsWorxWorker,
                                           private val errorBuilder: SimpleApiUserErrorBuilder) {
    /**
     * Сохранени замера
     */
    fun save(measurement: Measurement): Single<Result> {
        return thingsWorxWorker.setMeasurementInfo(measurement)
                .map { response ->
                    /**
