...
import ru.digipeople.locotech.inspector.ui.helper.AuthorizationChecker
import ru.digipeople.locotech.inspector.ui.helper.RxErrorHandler
...
class AppInitProvider : ContentProvider() {
    ...
    private fun initDI(appContext: Context) {
        ...
        AuthParams.apply {
            ...
            debugCredentials = Pair("инспектор3", "0000")
            specializationTitleText = "Выпуск на линию"
